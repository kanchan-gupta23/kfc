...
function Menu() {
  ...
  return (
    ...
    <div  className='w-screen  h-[550vh] bg-zinc-100 pt-[4vh]  relative  ' style={{ background: 'url("https://img.freepik.com/premium-photo/abstract-background-images-wallpaper-ai-generated_643360-18301.jpg")', width: '100vw', height: '550vh' }} >


    <div className='uppercase overflow-hidden mt-1 w-full flex texxtcont  h-[19vh] text-zinc-800 text-[2.5rem]  '>{"Browse Categories".split("").map((item,index)=>{
       return <span className='texxt text-[2.5rem] ' key={index}>{item}</span>;
     
     })}</div>
     
      {/* <div className=' grid grid-cols-3  gap-x-[10rem]   absolute top-1/2  left-[8%] -translate-y-1/2 '> */}
    ...
    drop-shadow	filter: drop-shadow(2px 2px 2px 2px black) drop-shadow( 5px 5px 5px 5px  black); Z-3
       ...
       <img  
        ...
        <h2  className='pra absolute z-9
          text-zinc-700 text-[4.5vh] top-[50%] left-1/2 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap uppercase 
        opacity-0
