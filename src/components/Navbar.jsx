...
function Navbar() {
  ...
  return (
   ...
   <div className=' w-[85vw]  h-[10vh] absolute z-10 -translate-x-1/2  flex  left-1/2  items-center  justify-between navi '> 
   
      <div className='flex nav1   w-1/2 gap-10  items-center ml-[10vw]'>
      <Link to="/"><img  className= ' navbar  kfc-logo w-[100px] h-[40px]' src='https://online.kfc.co.in/static/media/kfcLogo.492728c6.svg' alt='logo'/></Link>
